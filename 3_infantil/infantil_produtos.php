<?php
    ...
    WHERE Produto.Publico_alvo = 'Infantil' AND Produto.Categoria = 'Roupa' AND Produto.Usuario_admin IS NOT NULL";
        ...
        if ($resultado -> num_rows > 0){
            ...
            while ($produto = $resultado->fetch_assoc()) {
                ...
                <div class="product">
                    ...
                    <a class="btn-index" href="home.php?dir=3_infantil&file=detalhes_produto&codigo=<?php echo $produto['ID']; ?>">Saiba mais</a>
                </div>
                <?php
            }
            echo '</section>';
